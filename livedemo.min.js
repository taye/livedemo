/* livedemo 0.0.0 http://taye.mit-license.org */
...
"\n"===a.childNodes[0].nodeValue&&a.removeChild(a.childNodes[0]);try{eval(a.textContent)}catch(b){console.error("livedemo failed to execute a javascript code block"),console.log({element:a,error:b})}})});this.liveDemoSettings=this.liveDemoSettings||{};
